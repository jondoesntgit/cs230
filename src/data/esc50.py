...
Extracts features from each of the datasets and puts them into a folder defined
by ESC50_SPLITS in the .env file
...
for file_name in tqdm.tqdm(os.listdir(ESC50_RAW_DATA)):
    ...
    try:
        ...
        mel_feat = lib.feature.melspectrogram(
            y=y, sr=srate, n_fft=n_fft, hop_length=hop_length, n_mels=128)
